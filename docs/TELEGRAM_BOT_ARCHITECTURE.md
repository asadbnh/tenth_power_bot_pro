# 🗺️ خريطة وتوثيق مشروع بوت وتطبيق تيليجرام المستقل (Standalone Telegram Bot & Mini App)
### مؤسسة القوة العاشرة للمقاولات العامة والواجهات الزجاجية

> [!NOTE]
> **تحديث معماري هـام:** تم فصل كود بوت تيليجرام وتطبيق الميني آب ومحرك النسخ الاحتياطي بالكامل عن موقع الويب إلى مشروع مستقل وخفيف مخصص للرفع على خادم/سيرفر منفصل:
> المسار المحلي: `E:\projects\tenth-power-bot`

---

## 🧭 1. الخريطة الشجرية لمشروع البوت المستقل (`tenth-power-bot`)
