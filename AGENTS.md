...
### 📦 1. الهيكلية البرمجية المستقلة ([src/lib/backup/](file:///E:/projects/tenth-power-glass/src/lib/backup))

تم إنشاء المجلد المنفصل متضمناً:

- **[src/lib/backup/engine.ts](file:///E:/projects/tenth-power-glass/src/lib/backup/engine.ts):** محرك التصدير الشامل الذي يسحب الـ 40 جدولاً (بصيغتي SQL Dump و JSON) ويحمّل كافة الصور والوسائط من R2 ويضغطها داخل ملف `.zip` مؤرخ، ثم يرفعه مباشرة كملف وثيقة Document إلى تلجرام ويوثق العملية في جدول `backups`.
- **[src/lib/backup/restore.ts](file:///E:/projects/tenth-power-glass/src/lib/backup/restore.ts):** محرك الاستعادة المحلي الذي يفك ضغط الأرشيف ويستخرج جميع الصور إلى `public/images/restored/` ويقوم بحقن واسترجاع الجداول في قاعدة البيانات.
- **[src/lib/backup/index.ts](file:///E:/projects/tenth-power-glass/src/lib/backup/index.ts):** واجهة التصدير العامة.
...
تمت إضافة أوامر سريعة وجاهزة للاستخدام في [package.json](file:///E:/projects/tenth-power-glass/package.json):
