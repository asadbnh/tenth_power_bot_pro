    ...
    <div className="pt-[var(--header-height)] min-h-dvh bg-background">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="prose prose-gray dark:prose-invert max-w-none space-y-6 text-text-secondary leading-relaxed">
          <p>{isRtl
            ? `باستخدامك لموقع وخدمات ${companyName}، فإنك توافق على الالتزام بهذه الشروط والأحكام. يرجى قراءتها بعناية قبل الاستمرار.`
            : `By using the website and services of ${companyName}, you agree to abide by these terms and conditions. Please read them carefully before continuing.`}</p>
